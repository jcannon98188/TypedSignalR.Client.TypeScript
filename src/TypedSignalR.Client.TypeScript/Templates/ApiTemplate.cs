...
namespace TypedSignalR.Client.TypeScript.Templates
{
 ...
 if (Options.GenerateRxJSReceiver) { 
            this.Write("import { Subject as Subject$ } from \'rxjs\';\r\n");
 } 
            this.Write(@"
...
");
 ...
 foreach(var receiverType in ReceiverTypes) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(receiverType.FormatInterfaceNameAsConcrete()));
            this.Write(" = (connection: HubConnection) => {\r\n    ");
 foreach(var method in receiverType.Methods) { 
            this.Write("const __");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.Name.Format(Options.NamingStyle)));
            this.Write("$ = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.TranslateReceiverMethodIntoRxJSSubjectSyntax(SpecialSymbols, Options)));
            this.Write(";\r\n    connection.on(\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.Name));
            this.Write("\", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.TranslateReceiverMethodIntoRxJSConnectionNextSyntax(SpecialSymbols, Options)));
            this.Write(");\r\n    ");
 } 
            this.Write("\r\n    return {\r\n    ");
 foreach(var method in receiverType.Methods) { 
